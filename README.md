...
```bash
git clone https://github.com/SyncfusionExamples/Exporting-Blazor-Charts-Saving-as-Image-PDF-and-Excel.git
cd Exporting-Blazor-Charts-Saving-as-Image-PDF-and-Excel
```
